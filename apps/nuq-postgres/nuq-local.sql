-- NUQ PostgreSQL schema for local/self-hosted mode (no pg_cron required)
-- This is a simplified version of nuq.sql that works without Docker-specific extensions
